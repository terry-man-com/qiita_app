    ...
    <div class="article-create">
        <form action="{{ route('articles.update', $article->id )}}" method="POST">
            ...
            <div class="write-text">
                <label for="texarea"><span class="mgl"><i class="far fa-edit"></i></span><span class="mgl">本文</span></label>
                <textarea name="body" id="textarea" class="write-text-area" placeholder="記事の本文を記載してください">{{ $article->body }}</textarea>
            </div>
